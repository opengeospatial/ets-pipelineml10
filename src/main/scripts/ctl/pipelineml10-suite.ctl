...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/pipelineml10"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.pipelineml10.TestNGController">

  <ctl:function name="tns:run-ets-pipelineml10">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the pipelineml10 ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:suite name="tns:ets-pipelineml10-${version}">
     <ctl:title>PipelineML 1.0 Conformance Test Suite</ctl:title>
	  ...
	  <ctl:code>
        <xsl:variable name="form-data">
           <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
             <h2>PipelineML 1.0 Conformance Test Suite</h2>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-pipelineml10">

package org.opengis.cite.pipelineml10.level1;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.pipelineml10.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/pipelineml10/rnc/atom.rnc");

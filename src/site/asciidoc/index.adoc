= PipelineML 1.0 Conformance Test Suite
...
`org.opengis.cite.pipelineml10`. A conformance class corresponds to a &lt;test&gt; element, each
...
|Conformance Level 1
|org.opengis.cite.pipelineml10.level1.*

|Conformance Level 2
|org.opengis.cite.pipelineml10.level2.*
